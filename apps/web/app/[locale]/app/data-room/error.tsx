...
import { FileWarningIcon, RefreshCwIcon, ChevronLeftIcon } from "lucide-react";
        ...
        <div className="p-6">
            ...
            >
                <div className="relative mb-6 inline-block">
                    <div className="absolute inset-0 blur-xl opacity-20 bg-amber-500 rounded-full scale-150" />
                    <div className="relative p-4 rounded-xl border border-amber-500/20 bg-amber-500/5">
                        <FileWarningIcon className="w-12 h-12 text-amber-400" />
                    </div>
                </div>
                ...
                <p className="text-gray-400 mb-6">
                    Unable to access the secure data room. Please verify your permissions.
                </p>
